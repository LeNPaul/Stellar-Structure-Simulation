...
ax1[0].set_title('Distribution of the Final Successful Snatch for Males at the Olympics (2000 - 2016)')
...
ax1[1].set_title('Distribution of the Final Successful Clean & Jerk for Males at the Olympics (2000 - 2016)')
...
ax2[0].hist(s_data, bins=s_bin_size, color='dodgerblue', edgecolor='white')
ax2[0].set_xlim(45,155)
ax2[0].set_title('Distribution of the Final Successful Snatch for Females at the Olympics (2000 - 2016)')
...
ax2[1].set_title('Distribution of the Final Successful Clean & Jerk for Females at the Olympics (2000 - 2016)')
